...
// default.
module ScrewHole(outer_diam, height, position=[0,0,0],rotationAngle=0, rotationAxis=[0,0,0], pitch=0, tooth_angle=30, tolerance=0.4, tooth_height=0) {
...
module rabbitHole(outer_diam, height, position=[0,0,0],rotationAngle=0, rotationAxis=[0,0,0], pitch=0, tooth_angle=30, tolerance=0.4, tooth_height=0) {
  extra_height = 0.001 * height;
  translate([0,0,10])
  ScrewThread(1.01*outer_diam + 1.25*tolerance, height + extra_height,
    pitch, tooth_angle, tolerance, tooth_height=tooth_height);
