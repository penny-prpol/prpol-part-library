module straight_marble_track(
   ...
   union(){
        ...
        difference(){
            hull(){
                ...
                intersection(){
                    ...
                    path_extrude(exPath = straight_path, exShape = support_target_polypoints, exRots = [180]);
                }

            }
            path_extrude(exPath = straight_path, exShape = inner_circle, exRots = [180]);
        }
        ...
        //the marble track
        path_extrude(exPath = straight_path, exShape = polypoints, exRots = [180]);
   }
