...
module helix_marble_track(
    ...
    union(){
        ...
        //upper end connection (standard for all upper end)
        ...
        //lower left block to base of central column
        hull(){
            translate([helix_center_x, 100, -10])
        ...
        //upper left block to base of central column
        hull(){
            translate([helix_center_x, 100, -10])
            cylinder(d=4, h=10, $fn=30);
        ...
        //lower right block to base of central column
        hull(){
            translate([helix_center_x, 100, -10])
            cylinder(d=4, h=10, $fn=30);
        ...
        //upper right block to base of central column
        hull(){
            translate([helix_center_x, 100, -10])
            cylinder(d=4, h=10, $fn=30);
